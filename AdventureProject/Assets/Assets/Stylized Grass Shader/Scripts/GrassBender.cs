...
namespace StylizedGrass
{
    ...
    public class GrassBender : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (benderType == GrassBenderBase.BenderType.Trail)
            {
                targetPosition = this.transform.position;
                this.transform.position = Vector3.Lerp(targetPosition, targetPosition + (Random.insideUnitSphere * 0.001f), Time.deltaTime * 1000f);
            }
        }
