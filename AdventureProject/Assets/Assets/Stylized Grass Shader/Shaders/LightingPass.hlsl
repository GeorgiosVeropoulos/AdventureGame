...
#endif
{
	...
	float3 finalColor = half3(inputData.bakedGI * surfaceData.albedo + surfaceData.emission);
	
	return SurfaceDataToGbuffer(surfaceData, inputData, finalColor.rgb, kLightingSimpleLit);
